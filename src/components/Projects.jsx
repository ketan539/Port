    ...
    return (
        ...
        ">
            ...
            <a href={link} target="_blank" rel="noopener noreferrer" className="w-1/2 lg:w-full  cursor-pointer overflow-hidden rounded-lg">
                <motion.img src={img} alt={title} className="w-[50%] h-auto"
                ...
                <Layout className='pt-16'>
                    ...
                    <div className="grid grid-cols-12 mt-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
                        <div className="col-span-12">
                            <FeaturedProject
                                title="Modern Full-Stack Weather & Travel Companion App "
                                summary="Developed a full-stack web application that provides real-time weather updates, travel recommendations, and news insights by integrating multiple APIs (OpenWeather, WeatherAPI, GNews, Wikimedia) for comprehensive travel assistance."
                                type="Featured Project"
                                link="https://weather-frontend-puce.vercel.app/"
                                //github="https://github.com/ketan539/WeatherFrontend"
                                img={weatherApp}
                            />
                        </div>
